...
Tribunal TJRJ: Processo (eproc) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [tribunal_tjrj_processo_eproc@mcp.ai](mailto:tribunal_tjrj_processo_eproc@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
